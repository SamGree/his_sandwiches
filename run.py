...
SHEET = GSPREAD_CLIENT.open("his_sandwiches")
...
def get_stock_values(data):
    """
    Get the headings and create a dictionary with the headings as keys
    and the data values as values.
    """
...
# Print the variable stock_values to the terminal
print(stock_values)
